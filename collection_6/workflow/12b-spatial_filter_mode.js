// ============================================================
// Atlantic Forest (Bosque Atlántico) | Collection 6 | Step 12b — Spatial Filter: Focal Mode (Round 3)
// ============================================================
//
// DESCRIPTION:
//   Same focal-mode spatial filter as steps 06b/09b, applied here to
//   the Round-3 merged classification.
//
// METHODOLOGY: identical to step 06b — see that script for the full
// algorithm description.
//
// NOTE (kept as in the original): the exclusion condition still checks
// `.neq(3).neq(22).neq(33)` — classes that don't exist in Round 3's
// output (Round 3 only produces classes 15/19). Same inherited,
// no-effect condition as Round 2's step 09b — kept as found.
//
// INPUT:
//   - Merged Round-3 classification (step 12a output).
...
//     `step_16_filter_spatial_col6_v1_clas3`. (NOTE: the asset-name
//     step counter is not reset per round — it continues from earlier
//     rounds' highest step number, unrelated to this round's folder
//     name or to the later `step_16_Integration` folder.)
//
// PREVIOUS STEP: 12a-merge.js (produces the classification this script
//                filters)
// NEXT STEP:     12c-spatial_filter_connected.js
//
...
// 🔁 REPLACE: Merged Round-3 classification (step 12a output).
var class4GAP = ee.Image(dir_pre_class + '/step_09_gap-fill_col6_' + vesion_in + "_clas3");
...
Export.image.toAsset({
    ...
    // `dir_pre_class` above).
    "assetId": dir_pre_class + '/step_16_filter_spatial_col6_' + version_out + "_clas3",
    "scale": 30,
