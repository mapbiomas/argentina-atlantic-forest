// ============================================================
// Atlantic Forest (Bosque Atlántico) | Collection 6 | Step 15c — Spatial Filter: Connected Components (Round 4)
// ============================================================
//
// DESCRIPTION:
//   Same connected-component spatial filter as steps 06c/09c/12c,
//   applied here to classes 48 and 65.
//
// METHODOLOGY: identical to step 06c — see that script for the full
// algorithm description.
//
// INPUT:
//   - Spatially filtered classification (step 15b output).
...
//     `step_22_spatial_filter_col6_v1_clas3_yerbate`.
//
// PREVIOUS STEP: 15b-spatial_filter_mode.js (produces the classification
//                this script filters further)
// NEXT STEP:     15d-dominance_filter_yerba_te.js
//
...
// 🔁 REPLACE: Spatially filtered classification (step 15b output).
var class4GAP = ee.Image(dir_pre_class + '/step_21_filter_spatial_col6_v1_clas3_yerbate');
...
Export.image.toAsset({
    ...
    // `dir_pre_class` above).
    "assetId": dir_pre_class + '/step_22_spatial_filter_col6_' + version_out + "_clas3_yerbate",
    "scale": 30,
