// ============================================================
// Atlantic Forest (Bosque Atlántico) | Collection 6 | Step 15a — Merge Regions (Round 4)
// ============================================================
//
// DESCRIPTION:
//   Combines the 3 regions' Round-4 complement classifications (step 14
//   output) into a single national mosaic, using per-pixel
//   minimum-value priority to resolve overlaps. Same pattern as
//   09a-merge.js / 12a-merge.js — no gap-filling is actually applied
//   here either (see 09a-merge.js's NOTE).
//
// INPUT:
//   - Per-region Round-4 complement classifications (14-stable_map.js
...
//     `step_20_gap-fill_col6_v1_clas3_yerbate`.
//
// PREVIOUS STEP: 14-stable_map.js (produces each region's complement
//                classification)
// NEXT STEP:     15b-spatial_filter_mode.js
//
...
var version_out = 'v1';
var col = "col6_";
var prefixo_out = 'step_20_gap-fill_';
...
// 🔁 REPLACE: Per-region Round-4 complement classifications
// (14-stable_map.js output, both periods). NOTE: kept the "BA" prefix
// on the source asset names, as found (see 14-stable_map.js's NOTE).
...
var classif_reg1 = ee.Image(dircol5 + '/BAstep_04_reg_1-col_6_1985_class_v1_clas3_yerbate')
    .addBands(ee.Image(dircol5 + '/BAstep_04_reg_1-col_6_2000_class_v1_clas3_yerbate'));

var classif_reg2 = ee.Image(dircol5 + '/BAstep_04_reg_2-col_6_1985_class_v1_clas3_yerbate')
    .addBands(ee.Image(dircol5 + '/BAstep_04_reg_2-col_6_2000_class_v1_clas3_yerbate'));

var classif_reg3 = ee.Image(dircol5 + '/BAstep_04_reg_3-col_6_1985_class_v1_clas3_yerbate')
    .addBands(ee.Image(dircol5 + '/BAstep_04_reg_3-col_6_2000_class_v1_clas3_yerbate'));
...
Export.image.toAsset({
    'image': image,
    'description': prefixo_out + col + version_out + "_clas3_yerbate",
    // 🔁 REPLACE: Update to your own GEE asset folder (see `dirout`
    // above).
    'assetId': dirout + prefixo_out + col + version_out + "_clas3_yerbate",
