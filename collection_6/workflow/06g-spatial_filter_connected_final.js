// ============================================================
// Atlantic Forest (Bosque Atlántico) | Collection 6 | Step 06g — Spatial Filter: Connected Components, Final Pass (Round 1)
// ============================================================
//
// DESCRIPTION:
//   Final Round-1 post-processing step: re-applies the same
//   connected-component spatial filter as step 06c (small patches of
//   classes 3, 9, 10 replaced by their neighborhood's focal mode) to the
//   temporally filtered result, since the temporal filters can
//   reintroduce small spurious patches.
//
// METHODOLOGY:
//   Identical to step 06c — see that script for the full algorithm
//   description.
//
// INPUT:
...
//
// OUTPUT:
//   - Final Round-1 classification. Exported as
//     `step_08d_spatial_filter_col6_v1_clas1`.
//
// PREVIOUS STEP: 06f-temporal_filter_plantations_lastyears.js (produces
//                the classification this script filters)
// NEXT STEP:     07-preclassification.js (Round 2, refines this round's
//                class 10 "Otros")
//
...
// 🔁 REPLACE: Classification with recent-years plantation persistence
// forced (step 06f output).
var class4GAP = ee.Image(dir_pre_class + "/step_08c_filter_temporal_plantaciones_ultimosanios_col6_v1_clas1");
...
Export.image.toAsset({
    ...
    // `dir_pre_class` above).
    "assetId": dir_pre_class + '/step_08d_spatial_filter_col6_' + version_out + "_clas1",
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
