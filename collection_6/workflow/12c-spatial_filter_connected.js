// ============================================================
// Atlantic Forest (Bosque Atlántico) | Collection 6 | Step 12c — Spatial Filter: Connected Components (Round 3)
// ============================================================
//
// DESCRIPTION:
//   Same connected-component spatial filter as steps 06c/09c, applied
//   here to classes 15 and 19.
//
// METHODOLOGY: identical to step 06c — see that script for the full
// algorithm description.
//
// INPUT:
//   - Spatially filtered classification (step 12b output).
...
//     `step_17_spatial_filter_col6_v1_clas3`.
//
// PREVIOUS STEP: 12b-spatial_filter_mode.js (produces the classification
//                this script filters further)
// NEXT STEP:     12d-temporal_filter_allclasses.js
//
...
// 🔁 REPLACE: Spatially filtered classification (step 12b output).
var class4GAP = ee.Image(dir_pre_class + '/step_16_filter_spatial_col6_' + vesion_in + "_clas3");
...
Export.image.toAsset({
    ...
    // `dir_pre_class` above).
    "assetId": dir_pre_class + '/step_17_spatial_filter_col6_' + version_out + "_clas3",
    "scale": 30,
