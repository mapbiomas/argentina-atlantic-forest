// ============================================================
// Atlantic Forest (Bosque Atlántico) | Collection 6 | Step 15b — Spatial Filter: Focal Mode (Round 4)
// ============================================================
//
// DESCRIPTION:
//   Same focal-mode spatial filter as steps 06b/09b/12b, applied here to
//   the Round-4 merged classification.
//
...
// `.neq(3).neq(22).neq(33)` — classes that don't exist in Round 4's
// output (Round 4 only produces classes 48/65). Same inherited,
// no-effect condition as Rounds 2/3 — kept as found.
//
// INPUT:
//   - Merged Round-4 classification (step 15a output).
...
//     `step_21_filter_spatial_col6_v1_clas3_yerbate`.
//
// PREVIOUS STEP: 15a-merge.js (produces the classification this script
//                filters)
// NEXT STEP:     15c-spatial_filter_connected.js
//
...
// 🔁 REPLACE: Merged Round-4 classification (step 15a output).
var class4GAP = ee.Image(dir_pre_class + '/step_20_gap-fill_col6_v1_clas3_yerbate');
...
Export.image.toAsset({
    ...
    // `dir_pre_class` above).
    "assetId": dir_pre_class + '/step_21_filter_spatial_col6_' + version_out + "_clas3_yerbate",
    "scale": 30,
