...
var middle_plant = [36]; //[33, 3, 21, 13, 25]; 
var ordem_exec_first = [36]; //[3, 33, 21, 13, 25];
var ordem_exec_last = [36]; //[21];
...
var image_FE = ee.Image(dir_pre_class+'/step_08d_filter_temporal_plantaciones_col5_'+vesion_in)
...
Export.image.toAsset({
  ...
  "assetId": dir_pre_class + '/step_08e_filter_temporal_perennial_col5_'+version_out,
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
