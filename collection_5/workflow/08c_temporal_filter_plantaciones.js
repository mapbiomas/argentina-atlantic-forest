...
var image_FE = ee.Image(dir_pre_class+'/step_08c_filter_temporal_grasspast_col5_'+vesion_in)
...
var mask32 = function(valor, ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq (3)
        ...
        .or(imagem.select('classification_'+ (ano)              ).eq(36))
...
var mask42 = function(valor, ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq (3)
        ...
        .or(imagem.select('classification_'+ (parseInt(ano) + 1)).eq(36))
...
var mask52 = function(valor, ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq (3)
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 2)).eq(36))
...
var mask62 = function(valor, ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 3)).eq(36))
...
var mask72 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 4)).eq(36))
...
var mask82 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
       .and((imagem.select('classification_'+ (ano)              ).eq(22))
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 5)).eq(36))
...
var mask92 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
       .and((imagem.select('classification_'+ (ano)              ).eq(22))
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 6)).eq(36))
...
var mask102 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
       .and((imagem.select('classification_'+ (ano)              ).eq(22))
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 7)).eq(36))
...
var mask112 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
       .and((imagem.select('classification_'+ (ano)              ).eq(22))
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 8)).eq(36))
...
var mask122 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq(3)
       .and((imagem.select('classification_'+ (ano)              ).eq(22))
        ...
        .or(imagem.select('classification_'+ (parseInt(ano)   + 9)).eq(36))
...
var mask1223 = function(valor,ano, imagem){
  var mask = imagem.select('classification_'+ (parseInt(ano) - 1)).eq (valor)
        ...
        .or(imagem.select('classification_'+ (parseInt(ano) + 10)).eq(36))
...
Export.image.toAsset({
  ...
  "assetId": dir_pre_class + '/step_08d_filter_temporal_plantaciones_col5_'+version_out,
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
