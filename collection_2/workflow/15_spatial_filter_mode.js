////Adaptado por Pablo Baldassini - Agosto 2024
...
var class4GAP = ee.Image("projects/mapbiomas-argentina/assets/LAND-COVER/COLLECTION-2/GENERAL/CLASSIFICATION/FILTERS/BA/step_11_gap-fill_col5_v1_yerbate")
...
moda_85 = moda_85.mask(class4GAP.select('classification_'+ano).neq(3))
...
Export.image.toAsset({
  ...
  "assetId": dir_pre_class + '/step_12_filter_spatial_col5_'+version_out,
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
