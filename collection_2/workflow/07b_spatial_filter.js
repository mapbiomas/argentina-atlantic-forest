...
var class4GAP = ee.Image(dir_pre_class+'/step_07a_filter_spatial_col5_'+vesion_in)

var classes = [3,9,11,12,15,19,36]
...
Export.image.toAsset({
  ...
  "assetId": dir_pre_class + '/step_07b_spatial_filter_col5_'+version_out,
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
