...
//SUBIR SHAPE DE REA DE ESTUDIO SIN BUFFER Y RECORTAR LA CLASIF FINAL POR ESE LIMITE
...
var class4GAP = ee.Image(dir_pre_class+'/step_09b_filter_incidente_col3_'+vesion_in)
...
Export.image.toAsset({
  ...
  "description": 'final_regions_'+version_out,
  "assetId": dir_pre_class + '/step_10a_spatial_filter_col3_'+version_out,
  "scale": 30,
  "pyramidingPolicy": {
      '.default': 'mode'
  },
